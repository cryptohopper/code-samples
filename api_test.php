...
if(isset($_POST['access_key']) && isset($_POST['access_secret'])){
    if(!empty($_POST['access_key']) && !empty($_POST['access_secret'])){
        ...
        <div class="col-md-8 col-md-offset-2">
            <form class="form-horizontal" method="post" action="<?php echo $_SERVER['REQUEST_URI'];?>">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="password" class="form-control" name="access_key" value="<?php echo $access_key;?>">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">Access secret</label>
                    <div class="col-sm-10">
                        <input type="password" class="form-control" name="access_secret" value="<?php echo $access_secret;?>">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="operation" value="<?php echo $_POST['operation'];?>">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <select class="form-control" name="method">
                            <option value="GET" <?php if(!$_POST['method'] || $_POST['method'] == 'GET'){echo 'selected';}?>>GET</option>
                            <option value="POST" <?php if($_POST['method'] == 'POST'){echo 'selected';}?>>POST</option>
                            <option value="PATCH" <?php if($_POST['method'] == 'PATCH'){echo 'selected';}?>>PATCH</option>
                            <option value="DELETE" <?php if($_POST['method'] == 'DELETE'){echo 'selected';}?>>DELETE</option>
                        </select>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="data" rows="5" cols="20"><?php echo $_POST['data'];?></textarea>
                    </div>
                </div>
                <div class="form-group">
...
<div class="container">
    ...
    if($_POST['operation'] && $_POST['method']){

        $operation = $_POST['operation'];
        $method = $_POST['method'];

        $path = '/v1/'.$operation;
        $signature = hash_hmac('sha512', $path, $access_secret);
